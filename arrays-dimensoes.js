...
console.log(
  `${listaDeNotasDeAlunos[0][0]}, sua média é ${listaDeNotasDeAlunos[1][0]}`
);

// listaDeNotasDeAlunos[0][0] buscou a lista índice [0] dentro de listaDeNotasDeAlunos ou seja array alunos e  no índice de alunos[0] ou seja [João]

console.log(
  `${listaDeNotasDeAlunos[0][1]}, sua média é ${listaDeNotasDeAlunos[1][1]}`
);
